...
class CLIP_GCN_Model(nn.Module):
    def __init__(self):
        ...
        self.text_encoder = GCN(n = 6, edges_set=edge_index.unsqueeze(dim=0), in_channels=512, out_channels=512, hidden_layers='d256,d').to(device)
...
MODEL_PATH = Path("models")
MODEL_NAME = "CLIP+GCN_Model_gcnatt.pth"
MODEL_SAVE_PATH = MODEL_PATH / MODEL_NAME
