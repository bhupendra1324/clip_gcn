...
class CLIP_GCN_Model(nn.Module):
    def __init__(self):
        ...
        self.text_encoder = GCN(n = 70, edges=edge_index, in_channels=512, out_channels=512, hidden_layers='d256,d').to(device)
...
MODEL_PATH = Path("models")
MODEL_NAME = "CLIP+GCN_caltech_Newgcn.pth"
MODEL_SAVE_PATH = MODEL_PATH / MODEL_NAME
...
savetxt('caltech_features.csv', features, delimiter=',')
savetxt('caltech_labels.csv', labels, delimiter=',')
