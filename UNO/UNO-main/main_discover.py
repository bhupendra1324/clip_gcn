...
class Discoverer(pl.LightningModule):
    ...
    def training_step(self, batch, _):
        ...
        # print("This is from train {}".format(results))
        ...
        for dl_idx, (result, result_inc) in enumerate(zip(results, results_inc)):
            ...
            if "unlab" in prefix:
                for (metric, values), (_, values_inc) in zip(result.items(), result_inc.items()):
                    ...
                    print(name+' avg is {}'.format(avg))
                    print(name+' best is {}'.format(best))
                    print(name_inc+' avg is {}'.format(avg_inc))
                    print(name_inc+' best is {}'.format(best_inc))
                ...
                print(prefix+' acc is {}'.format(result))
                print(prefix+' acc is {}'.format(result_inc))
